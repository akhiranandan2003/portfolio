...
const contacts = [
  {
    ...
    label: "Email",
    value: "akhiranandanthota@gmail.com",
    link: "mailto:akhiranandanthota@gmail.com"
  },
  {
    icon: <Phone className="h-6 w-6" />,
    label: "Phone",
    value: "+91 8688485414",
    link: "tel:+918688485414"
  },
  {
    icon: <Github className="h-6 w-6" />,
    label: "GitHub",
    value: "github.com/akhiranandan2003",
    link: "https://github.com/akhiranandan2003"
  },
  {
    icon: <Linkedin className="h-6 w-6" />,
    label: "LinkedIn",
    value: "linkedin.com/in/akhira-nandan-thota",
    link: "https://www.linkedin.com/in/akhira-nandan-thota-653b87290/"
  },
  {
    icon: <FileText className="h-6 w-6" />,
    label: "Resume",
    value: "View Resume",
    link: "/Akhira_Nandan_Thota_Resume.pdf"
  }
];
