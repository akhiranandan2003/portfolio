        ...
        >
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 gradient-bg">
            <div className="flex flex-col items-center text-center">
              ...
              <div className="mt-4">
                <h3 className="text-2xl font-bold gradient-text">🎓 Kakatiya Institute of Technology and Science (KITS), Warangal</h3>
                ...
                <h4 className="text-xl font-medium mb-2">💻 Bachelor of Technology in Computer Science Engineering</h4>
                
                <div className="mt-4">
                  <h5 className="font-medium mb-2">📚 Relevant Courses:</h5>
                  <div className="flex flex-wrap justify-center gap-2">
                    {["DSA", "OOP", "DBMS", "Software Engineering"].map((course, index) => (
                      <span 
                        key={index} 
