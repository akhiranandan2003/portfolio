...
const skills: SkillBubble[] = [
  ...
  { name: "SQL", size: "md", category: "language" },
  { name: "HTML5", size: "sm", category: "web" },
  { name: "CSS3", size: "sm", category: "web" },
  { name: "JavaScript", size: "md", category: "web" },
  { name: "React", size: "lg", category: "web" },
  { name: "Bootstrap", size: "sm", category: "web" },
  { name: "Node.js", size: "md", category: "web" },
  { name: "Express.js", size: "md", category: "web" },
  { name: "REST APIs", size: "md", category: "web" },
  { name: "Machine Learning", size: "lg", category: "tech" },
  { name: "RAG", size: "md", category: "tech" },
  { name: "LangChain", size: "md", category: "tech" },
  { name: "Prompt Engineering", size: "sm", category: "tech" },
  { name: "Salesforce Apex", size: "lg", category: "tech" },
  { name: "LWC", size: "md", category: "tech" },
